...
{ 
    ...
    /// </summary>
    [DataContract]
    public class ProductionGreenResponse : IEquatable<ProductionGreenResponse>
    {
        /// <summary>
        /// Exposure level in percentage of the green production environment to user traffic (0-100)
        /// </summary>
        /// <value>Exposure level in percentage of the green production environment to user traffic (0-100)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductionGreenResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ProductionGreenResponse)obj);
        }

        /// <summary>
        /// Returns true if ProductionGreenResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ProductionGreenResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductionGreenResponse other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + Exposure.GetHashCode();
                    if (SandboxId != null)
        ...
        public static bool operator ==(ProductionGreenResponse left, ProductionGreenResponse right)
        {
