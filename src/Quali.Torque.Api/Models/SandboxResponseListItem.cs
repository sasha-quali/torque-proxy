...
{ 
    ...
    /// </summary>
    [DataContract]
    public class SandboxResponseListItem : IEquatable<SandboxResponseListItem>
    {
        /// <summary>
        /// Gets or Sets Applications
        /// </summary>
        [DataMember(Name="applications", EmitDefaultValue=true)]
        public List<ApplicationResponseBase> Applications { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SandboxResponseListItem {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SandboxResponseListItem)obj);
        }

        /// <summary>
        /// Returns true if SandboxResponseListItem instances are equal
        /// </summary>
        /// <param name="other">Instance of SandboxResponseListItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SandboxResponseListItem other)
        {
        ...
        public static bool operator ==(SandboxResponseListItem left, SandboxResponseListItem right)
        {
