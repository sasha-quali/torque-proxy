...
{ 
    ...
    /// </summary>
    [DataContract]
    public class BlueprintCostResponse : IEquatable<BlueprintCostResponse>
    {
        /// <summary>
        /// Gets or Sets AverageHourlyCost
        /// </summary>
        [DataMember(Name="average_hourly_cost", EmitDefaultValue=false)]
        public double AverageHourlyCost { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BlueprintCostResponse {\n");
            sb.Append("  AverageHourlyCost: ").Append(AverageHourlyCost).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BlueprintCostResponse)obj);
        }

        /// <summary>
        /// Returns true if BlueprintCostResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of BlueprintCostResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlueprintCostResponse other)
        {
            ...
            return 
                (
                    AverageHourlyCost == other.AverageHourlyCost ||
                    
                    AverageHourlyCost.Equals(other.AverageHourlyCost)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AverageHourlyCost.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(BlueprintCostResponse left, BlueprintCostResponse right)
        {
